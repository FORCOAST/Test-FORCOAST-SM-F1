...
#Import layers
#Set path to layers
basemap_path = "/usr/src/app/Skobbler_basemap.xml"
HSI_fishing_path = "/usr/src/app/20220414T000000000Z.tif"
boundaries_path = "/usr/src/app/RO_BG_EEZ_Boundaries_polygon.shp"
...
Custom = QgsRectangle(QgsPointXY(float(sys.argv[1]), float(sys.argv[2])),QgsPointXY(float(sys.argv[3]),float(sys.argv[4])))
...
logo.setPicturePath("/usr/src/app/FORCOAST_Logo_WhiteBack.png")
...
footer.setPicturePath("/usr/src/app/FORCOAST_Footer_Blue.png")
...
export_path_pdf = "/usr/src/app/F1-Bulletin-map.pdf"
export_path_png = "/usr/src/app/F1-Bulletin-map.png"
